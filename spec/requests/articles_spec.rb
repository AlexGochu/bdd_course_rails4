...
RSpec.describe "Article", type: :request do
  ...
  describe 'DELETE /articles/:id' do
    ...
    context 'with signed in user who is no-owner' do
      before do
        login_as(@fred)
    ...
    context 'with signed in as owner successfull delete' do
      before do
        login_as(@john)
        delete "/articles/#{@article.id}"
      end
  ...
  describe 'GET /articles/:id/edit' do
    ...
    context 'with signed in as owner successfull edit' do
      before do
        login_as(@john)
        get "/articles/#{@article.id}/edit"
      end
